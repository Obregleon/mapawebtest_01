...
map.getView().fit([-9864484.826145, -2049059.527580, -6493772.544991, 125992.273029], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Departaments del Peru</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (13 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Obregon_Leon';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_departamento_sencico_1,
    colName: 'NAME_1',
    zoom: 10,
    collapsed: true,
    map: map
